//! The command line handler abstraction for IPC agent.
...
/// how to register.
///
/// Note that this trait does not support the implementation to have states as we are targeting cli.
/// Initialize the states in the `handle` method or pass in from the implementation constructor.
#[async_trait]
